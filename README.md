...
trident:generate:resource                     | Create a resource | {entity_name} {--collection} {--workflow} {--schema_path=}
trident:generate:restful_crud                 | Create a RESTFUL CRUD | {name} {--model_db_name=} {--schema_path=}
trident:generate:strict_type                  | Create a strict type | {strict_type_name} {function_name} {entity_name} {--workflow} {--schema_path=}
trident:generate:validation                   | Create a validation | {entity_name} {function_name} {--schema_path=}
